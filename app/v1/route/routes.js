module.exports = (app) => {
   ...
   app.get(versao + "/pastas/:nomePasta", pasta.listar);
   ...
   app.get(versao + "/pastas/:nomePasta/subpasta/:nomeSubPasta", subpasta.listar);
   app.get(versao + "/:nomePasta/:subPasta", subpasta.listar);
