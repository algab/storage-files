        ...
        try {
            ...
            if (data.email && data.password) {
                ...
                if (result == null) {
                    ...
                    app.locals.winston.info({ email: data.email, message: 'Login' }, { agent: headers['user-agent'] });
            ...
            if (body.email) {
                ...
                if (result) {
                    ...
                    if (resultManager) {
                        ...
                        app.locals.winston.info({ email: body.email, message: 'Manager password changed' }, { agent: headers['user-agent'] });
                        res.status(200).json({ Message: 'Password changed successful' }).end();
                    } else {
